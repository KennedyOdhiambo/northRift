...
type Action =
  ...
  | { type: 'setReturnDate'; payload: Date | null }
...
export default function TravelForm({ returnTrip }: { returnTrip: boolean }) {
      ...
      {returnTrip && (
        <div>
          <CustomDatePicker
            ...
            handleDateChange={(date) => dispatch({ type: 'setReturnDate', payload: date })}
            text="Return Date"
          />
        </div>
      )}
